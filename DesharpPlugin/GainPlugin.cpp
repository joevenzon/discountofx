...
#define kPluginName "Desharp"
#define kPluginGrouping "DiscountOFX"
#define kPluginDescription "Reduce digital micro-sharpening effects, or add them"
#define kPluginIdentifier "com.DiscountOFX.Desharp"
